...
| **D-0002** | Migration 019 실적용 검증 미완 | 2026-03-31 | 2026-04-24 | IN_PROGRESS | `.omc/plans/open-questions.md` 'P0 Critical Bugs' 섹션, `019_vcx_fix_get_user_info.sql` | `scripts/verify-rpc-applied.sh` 작성 (2026-05-05 완료) + Sentry 에러 0건 확인 (수동) |
