...
const PILLARS = [
  {
    ...
    label: 'CURATION FEED',
    title: '채용시장 큐레이션 피드',
    desc: '관심 분야를 등록하면 해당 시장의 핵심 포지션이 매주 자동으로 도착합니다. 딥테크, 핀테크, AI — 노이즈 없이 당신의 시장만.',
    insight:
  ...
  },
  {
    ...
    title: '의사결정자와의 직접 채널',
    desc: 'CEO가 먼저 손을 내밉니다. 채용 공고가 담지 못하는 것 — 조직의 언어, 리더십의 결, 암묵적 기대치. 역방향 채용 구조.',
    insight:
      '정보 비대칭은 채용 시장의 근본 문제다. CEO 커피챗은 이 비대칭을 가장 효율적으로 해소하는 구조다.',
    icon: '◎',
    href: '/ceo-coffeechat',
  },
  {
